...
def split_video_into_frames(video_path, output_path, max_frames=200, blur_check = True):
...
def test():
  ...
  wanted_frames = 200
  blur = True
  split_video_into_frames(instance_name, output_path, ffmpeg_path, video_path, wanted_frames, blur)
